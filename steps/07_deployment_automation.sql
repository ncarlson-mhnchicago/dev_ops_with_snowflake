...
show parameters like 'data_retention_time_in_days' in table DEVOPS_WITH_SNOWFLAKE_DEV.gold.vacation_spots;
-- should return 1 (due to deploy_pipeline_dev.yml)
show parameters like 'data_retention_time_in_days' in table DEVOPS_WITH_SNOWFLAKE_PROD.gold.vacation_spots;
